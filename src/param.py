...
# 普通进攻 striker 的射门力度。后场数值独立保留，便于以后单独增强解围式射门。
OFFENSIVE_STRIKER_KICK_POWER = 5.0
OFFENSIVE_STRIKER_BACKFIELD_KICK_POWER = 5.0
...
OFFENSIVE_STRIKER_KICK_ENTER_M = 2.0
OFFENSIVE_STRIKER_KICK_EXIT_M = 2.5
...
# 射门触发动态放宽：离对方球门较近时更容易大脚，远距离不正时仍先调整。
OFFENSIVE_STRIKER_FAR_SHOT_GOAL_DISTANCE_M = 4.50
OFFENSIVE_STRIKER_FAR_SHOT_ENTER_ANGLE_RAD = math.radians(35.0)
OFFENSIVE_STRIKER_FAR_SHOT_EXIT_ANGLE_RAD = math.radians(50.0)
OFFENSIVE_STRIKER_RELAXED_SHOT_ENTER_ANGLE_RAD = math.radians(60.0)
OFFENSIVE_STRIKER_RELAXED_SHOT_EXIT_ANGLE_RAD = math.radians(75.0)
