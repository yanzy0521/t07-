...
OFFENSIVE_STRIKER_DIRECT_ENTER_ANGLE_RAD = math.radians(25.0)
OFFENSIVE_STRIKER_DIRECT_EXIT_ANGLE_RAD = math.radians(40.0)
OFFENSIVE_STRIKER_CIRCLE_PROGRESS_RAD = math.radians(5.0)
OFFENSIVE_STRIKER_CIRCLE_TIMEOUT_SEC = 3.0
OFFENSIVE_STRIKER_CIRCLE_FALLBACK_SEC = 1.0
...
DEFENSIVE_PRESSER_KEEP_DISTANCE_MARGIN_M = 0.3
...
# 防守逼抢者直接追球，并在进入独立距离后按独立力度解围。
DEFENSIVE_PRESSER_CLEAR_DISTANCE_M = 0.5
DEFENSIVE_PRESSER_CLEAR_POWER = 5.0
